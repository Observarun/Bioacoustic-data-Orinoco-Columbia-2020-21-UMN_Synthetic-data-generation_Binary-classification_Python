...
In the context of vision architectures, the weights in question are in the filters

Pooling layer is used to reduce the size (dimensionality) of the feature map generated by the convolution layer. It summarises the features in the input, through averaging, or selecting maximum of each section. This has a very important consequence - invariance. While in the original image, the location or orientation of the subject might have been relevant, the summarised feature map is invariant to translation/rotation/deformation.
