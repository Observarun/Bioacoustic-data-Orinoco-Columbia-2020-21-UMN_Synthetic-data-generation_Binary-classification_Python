...
The loss function I've used is the sum of binary cross entropy and KL divergence. I used Adam optimiser, which offers a modified form of stochastic gradient descent. I experimented with learning rates of $10^{-3}$, $10^{-4}$, $10^{-5}$, and a stepwise decay w/ learning rate starting at $10^{-4}$ and being multiplied by $0.5$ every $10$ epochs. Finally, I settled for $10^{-5}$. Since I have only $95$ data points to begin with, I used a small batch size of $32$. For number of epochs, I choose a rather large value of $800$ because of the small dataset.
...
Cross entropy loss for binary classification. Optimiser: SGD.
